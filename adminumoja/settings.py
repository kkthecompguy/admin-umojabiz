"""
Django settings for adminumoja project.
...
SECRET_KEY = '3s(2gu48w7l3#ufyp8b(htm1ku2+n(cw#o8b8e3wv*1h7!5dr0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'adminumojabiz.herokuapp.com']
...
WSGI_APPLICATION = 'adminumoja.wsgi.application'
